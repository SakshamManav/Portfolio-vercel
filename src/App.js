...
import BgRemoverProject from "./Components/BGremover";
import FeeManagementSystem from "./Components/feemanagementsystem";
function App() {
  useEffect(() => {
    ...
    <Router>
      <div className="App">
        <Routes>
          ...
          />
          <Route path="/bgremover-project" element={ <> <Particles particleCount={200}/> <BgRemoverProject/> </>} />
